...
class UserTable extends Table
{
    public static function selectByUsername($username, $fetch = true)
    {
        ...
        return self::select(["users"], ["id", "username", "password", "EmailVerified", "email"])->where(["username"], ["="], [$username], ["s"])
            ->execute(true, $fetch);
    }
    ...
    public static function insertToUser($value)
    {
        ...
        self::insert(
            "users",
            ["email", "username", "password", "firstname", "lastname", "EmailVerificationCode", "Address", "RoleID"],
